...
<h3>Take a guess!</h3>
		...
		<% if ((session.getAttribute("didGuess") == "yes") && (session.getAttribute("guessResult") == "1" )){ %>
			<div class="alert red">
				<p>Too high!</p>
			</div>
		<% } %>
		...
		<% if ((session.getAttribute("didGuess") == "yes") && (session.getAttribute("guessResult") == "0" )){ %>
			<div class="alert green">
					<p>Yes!  <c:out value="${targetNumber}" /> Is the number</p>
...
<p>Target number is <c:out value="${targetNumber}"/></p>
